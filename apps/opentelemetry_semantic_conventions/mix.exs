  ...
  def project do
    ...
    [
      ...
      docs: [
        ...
        extras: guides() ++ [],
        groups_for_extras: [
          General: Path.wildcard("guides/{general,non-normative}/**/*.md"),
          App: Path.wildcard("guides/app/*.md"),
          "Attributes Registry": Path.wildcard("guides/attributes-registry/*.md"),
          Azure: Path.wildcard("guides/azure/*.md"),
          Browser: Path.wildcard("guides/browser/*.md"),
          "CI/CD": Path.wildcard("guides/cicd/*.md"),
          CLI: Path.wildcard("guides/cli/*.md"),
          "Cloud Providers": Path.wildcard("guides/cloud-providers/*.md"),
          "Cloud Events": Path.wildcard("guides/cloudevents/*.md"),
          Code: Path.wildcard("guides/code/*.md"),
          ...
          Hardware: Path.wildcard("guides/{hardware,hw}/*.md"),
          ...
          OTel: Path.wildcard("guides/otel/*.md"),
