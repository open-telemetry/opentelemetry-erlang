defmodule OpenTelemetry.SemanticConventions.ServiceAttributes do
  ...
  **SHOULD** use the following UUID as the namespace: `4d63009a-8d0f-11ee-aad7-4c796ed8e320`.
  ...
  ### Example
      iex> OpenTelemetry.SemanticConventions.ServiceAttributes.service_instance_id()
      :"service.instance.id"
  """
  ...
  ### Example
      iex> OpenTelemetry.SemanticConventions.ServiceAttributes.service_name()
      :"service.name"
  """
  ...
  ### Example
      iex> OpenTelemetry.SemanticConventions.ServiceAttributes.service_namespace()
      :"service.namespace"
  """
  ...
  ### Example
      iex> OpenTelemetry.SemanticConventions.ServiceAttributes.service_version()
      :"service.version"
  """
