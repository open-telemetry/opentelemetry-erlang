defmodule OpenTelemetry.SemConv.Incubating.Metrics.SystemMetrics do
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.SystemMetrics.system_disk_iotime()
      :"system.disk.io_time"
  ...
  @spec system_disk_iotime :: :"system.disk.io_time"
  def system_disk_iotime do
    :"system.disk.io_time"
  end
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.SystemMetrics.system_disk_operationtime()
      :"system.disk.operation_time"

  ### Erlang

  ```erlang
  ?SYSTEM_DISK_OPERATIONTIME.
  'system.disk.operation_time'
  ```
  ...
  @spec system_disk_operationtime :: :"system.disk.operation_time"
  def system_disk_operationtime do
    :"system.disk.operation_time"
  end
