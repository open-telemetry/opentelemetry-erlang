defmodule OpenTelemetry.SemConv.Incubating.Metrics.RpcMetrics do
  ...
  **Streaming**: This metric is required for server and client streaming RPCs
  ...
  @spec rpc_client_requestsperrpc :: :"rpc.client.requests_per_rpc"
  def rpc_client_requestsperrpc do
    :"rpc.client.requests_per_rpc"
  end
  ...
  **Streaming**: This metric is required for server and client streaming RPCs
  ...
  @spec rpc_client_responsesperrpc :: :"rpc.client.responses_per_rpc"
  def rpc_client_responsesperrpc do
    :"rpc.client.responses_per_rpc"
  end
  ...
  **Streaming** : This metric is required for server and client streaming RPCs
  ...
  @spec rpc_server_requestsperrpc :: :"rpc.server.requests_per_rpc"
  def rpc_server_requestsperrpc do
    :"rpc.server.requests_per_rpc"
  end
  ...
  **Streaming**: This metric is required for server and client streaming RPCs
  ...
  @spec rpc_server_responsesperrpc :: :"rpc.server.responses_per_rpc"
  def rpc_server_responsesperrpc do
    :"rpc.server.responses_per_rpc"
  end
end
