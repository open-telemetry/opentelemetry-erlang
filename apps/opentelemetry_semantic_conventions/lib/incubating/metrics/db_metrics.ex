defmodule OpenTelemetry.SemConv.Incubating.Metrics.DbMetrics do
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.DbMetrics.db_client_connection_createtime()
      :"db.client.connection.create_time"

  ### Erlang

  ```erlang
  ?DB_CLIENT_CONNECTION_CREATETIME.
  'db.client.connection.create_time'
  ```
  ...
  @spec db_client_connection_createtime :: :"db.client.connection.create_time"
  def db_client_connection_createtime do
    :"db.client.connection.create_time"
  end
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.DbMetrics.db_client_connection_pendingrequests()
      :"db.client.connection.pending_requests"

  ### Erlang

  ```erlang
  ?DB_CLIENT_CONNECTION_PENDINGREQUESTS.
  'db.client.connection.pending_requests'
  ```
  ...
  @spec db_client_connection_pendingrequests :: :"db.client.connection.pending_requests"
  def db_client_connection_pendingrequests do
    :"db.client.connection.pending_requests"
  end
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.DbMetrics.db_client_connection_usetime()
      :"db.client.connection.use_time"

  ### Erlang

  ```erlang
  ?DB_CLIENT_CONNECTION_USETIME.
  'db.client.connection.use_time'
  ```
  ...
  @spec db_client_connection_usetime :: :"db.client.connection.use_time"
  def db_client_connection_usetime do
    :"db.client.connection.use_time"
  end
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.DbMetrics.db_client_connection_waittime()
      :"db.client.connection.wait_time"

  ### Erlang

  ```erlang
  ?DB_CLIENT_CONNECTION_WAITTIME.
  'db.client.connection.wait_time'
  ```
  ...
  def db_client_connection_waittime do
    :"db.client.connection.wait_time"
  end
  ...
  @spec db_client_connections_createtime :: :"db.client.connections.create_time"
  def db_client_connections_createtime do
  ...
  @spec db_client_connections_pendingrequests :: :"db.client.connections.pending_requests"
  def db_client_connections_pendingrequests do
  ...
  @spec db_client_connections_usetime :: :"db.client.connections.use_time"
  def db_client_connections_usetime do
  ...
  @spec db_client_connections_waittime :: :"db.client.connections.wait_time"
  def db_client_connections_waittime do
