defmodule OpenTelemetry.SemConv.Incubating.Metrics.ProcessMetrics do
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.ProcessMetrics.process_contextswitches()
  ...
  @spec process_contextswitches :: :"process.context_switches"
  def process_contextswitches do
    :"process.context_switches"
  end
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.ProcessMetrics.process_openfiledescriptor_count()
      :"process.open_file_descriptor.count"

  ### Erlang

  ```erlang
  ?PROCESS_OPENFILEDESCRIPTOR_COUNT.
  'process.open_file_descriptor.count'
  ```
  ...
  @spec process_openfiledescriptor_count :: :"process.open_file_descriptor.count"
  def process_openfiledescriptor_count do
    :"process.open_file_descriptor.count"
  end
