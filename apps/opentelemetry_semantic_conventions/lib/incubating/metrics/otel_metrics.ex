defmodule OpenTelemetry.SemConv.Incubating.Metrics.OtelMetrics do
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.Metrics.OtelMetrics.otel_sdk_span_started()
  ...
  @spec otel_sdk_span_started :: :"otel.sdk.span.started"
  def otel_sdk_span_started do
    :"otel.sdk.span.started"
  end
end
