defmodule OpenTelemetry.SemConv.Incubating.Metrics.HttpMetrics do
  ...
  @spec http_client_activerequests :: :"http.client.active_requests"
  def http_client_activerequests do
    :"http.client.active_requests"
  end
  ...
  @spec http_client_openconnections :: :"http.client.open_connections"
  def http_client_openconnections do
    :"http.client.open_connections"
  end
  ...
  @spec http_server_activerequests :: :"http.server.active_requests"
  def http_server_activerequests do
    :"http.server.active_requests"
  end
