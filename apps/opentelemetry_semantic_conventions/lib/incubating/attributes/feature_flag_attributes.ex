defmodule OpenTelemetry.SemConv.Incubating.FeatureFlagAttributes do
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.FeatureFlagAttributes.feature_flag_error_message()
  ...
  <!-- tabs-close -->
  """
  @spec feature_flag_error_message :: :"feature_flag.error.message"
  def feature_flag_error_message do
    :"feature_flag.error.message"
  end

  @deprecated """
  Replaced by `feature_flag.error.message`.
  """
  ...
  * `:error` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - The resolved value was the result of an error.
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.FeatureFlagAttributes.feature_flag_result_value()
  ...
  <!-- tabs-close -->
  """
  @spec feature_flag_result_value :: :"feature_flag.result.value"
  def feature_flag_result_value do
    :"feature_flag.result.value"
  end
