defmodule OpenTelemetry.SemConv.Incubating.CassandraAttributes do
  ...
  ### Enum Values
  * `:all` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - All
  * `:each_quorum` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Each Quorum
  * `:quorum` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Quorum
  * `:local_quorum` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Local Quorum
  * `:one` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - One
  * `:two` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Two
  * `:three` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Three
  * `:local_one` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Local One
  * `:any` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Any
  * `:serial` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Serial
  * `:local_serial` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Local Serial
  """
