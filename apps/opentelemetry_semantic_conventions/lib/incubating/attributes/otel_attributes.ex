defmodule OpenTelemetry.SemConv.Incubating.OtelAttributes do
  ...
  * `:zipkin_http_span_exporter` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Zipkin span exporter over HTTP
  ...
  * `:prometheus_http_text_metric_exporter` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Prometheus metric exporter over HTTP with the default text-based format
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.OtelAttributes.otel_event_name()
      :"otel.event.name"
  ...
  <!-- tabs-close -->
  """
  @spec otel_event_name :: :"otel.event.name"
  def otel_event_name do
    :"otel.event.name"
  end
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.OtelAttributes.otel_scope_schema_url()
  ...
  <!-- tabs-close -->
  """
  @spec otel_scope_schema_url :: :"otel.scope.schema_url"
  def otel_scope_schema_url do
    :"otel.scope.schema_url"
  end
  ...
  ### Enum Values
  * `:none` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - The span does not have a parent, it is a root span
  * `:local` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - The span has a parent and the parent's span context [isRemote()](https://opentelemetry.io/docs/specs/otel/trace/api/#isremote) is false
  * `:remote` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - The span has a parent and the parent's span context [isRemote()](https://opentelemetry.io/docs/specs/otel/trace/api/#isremote) is true
  """
  @type otel_span_parent_origin_values() :: %{
          :none => :none,
          :local => :local,
          :remote => :remote
        }
  ...
  ### Elixir
      ...
      iex> OpenTelemetry.SemConv.Incubating.OtelAttributes.otel_span_parent_origin()
      :"otel.span.parent.origin"

      iex> OpenTelemetry.SemConv.Incubating.OtelAttributes.otel_span_parent_origin_values().none
      :none

      iex> %{OpenTelemetry.SemConv.Incubating.OtelAttributes.otel_span_parent_origin() => OpenTelemetry.SemConv.Incubating.OtelAttributes.otel_span_parent_origin_values().none}
  ...
  ?OTEL_SPAN_PARENT_ORIGIN_VALUES_NONE.
  'none'

  \#{?OTEL_SPAN_PARENT_ORIGIN => ?OTEL_SPAN_PARENT_ORIGIN_VALUES_NONE}.
  \#{'otel.span.parent.origin' => 'none'}
  ```

  <!-- tabs-close -->
  """
  @spec otel_span_parent_origin :: :"otel.span.parent.origin"
  def otel_span_parent_origin do
    :"otel.span.parent.origin"
  end

  @spec otel_span_parent_origin_values() :: otel_span_parent_origin_values()
  def otel_span_parent_origin_values() do
    %{
      :none => :none,
      :local => :local,
      :remote => :remote
