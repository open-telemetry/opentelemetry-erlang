defmodule OpenTelemetry.SemConv.Incubating.MessagingAttributes do
  ...
  * `:publish` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - **deprecated** ~~Deprecated. Use `send` instead.~~
  """
  ...
  * `:"aws.sns"` ^[e](`m:OpenTelemetry.SemConv#experimental`)^ - Amazon Simple Notification Service (SNS)
