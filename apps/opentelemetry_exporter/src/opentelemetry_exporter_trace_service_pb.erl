...
-type 'opentelemetry.proto.trace.v1.SpanFlags'() :: 'SPAN_FLAGS_DO_NOT_USE' | 'SPAN_FLAGS_TRACE_FLAGS_MASK' | 'SPAN_FLAGS_CONTEXT_HAS_IS_REMOTE_MASK' | 'SPAN_FLAGS_CONTEXT_IS_REMOTE_MASK'.
...
-type entity_ref() ::
      #{schema_url              => unicode:chardata(), % = 1, optional
        type                    => unicode:chardata(), % = 2, optional
        id_keys                 => [unicode:chardata()], % = 3, repeated
        description_keys        => [unicode:chardata()] % = 4, repeated
       }.

-type resource() ::
      #{attributes              => [key_value()],   % = 1, repeated
        dropped_attributes_count => non_neg_integer(), % = 2, optional, 32 bits
        entity_refs             => [entity_ref()]   % = 3, repeated
       }.

-export_type(['export_trace_service_request'/0, 'export_trace_service_response'/0, 'export_trace_partial_success'/0, 'traces_data'/0, 'resource_spans'/0, 'scope_spans'/0, 'event'/0, 'link'/0, 'span'/0, 'status'/0, 'any_value'/0, 'array_value'/0, 'key_value_list'/0, 'key_value'/0, 'instrumentation_scope'/0, 'entity_ref'/0, 'resource'/0]).
-type '$msg_name'() :: export_trace_service_request | export_trace_service_response | export_trace_partial_success | traces_data | resource_spans | scope_spans | event | link | span | status | any_value | array_value | key_value_list | key_value | instrumentation_scope | entity_ref | resource.
-type '$msg'() :: export_trace_service_request() | export_trace_service_response() | export_trace_partial_success() | traces_data() | resource_spans() | scope_spans() | event() | link() | span() | status() | any_value() | array_value() | key_value_list() | key_value() | instrumentation_scope() | entity_ref() | resource().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        entity_ref -> encode_msg_entity_ref(id(Msg, TrUserData), TrUserData);
...
encode_msg_entity_ref(Msg, TrUserData) -> encode_msg_entity_ref(Msg, <<>>, TrUserData).


encode_msg_entity_ref(#{} = M, Bin, TrUserData) ->
    B1 = case M of
             #{schema_url := F1} ->
                 begin
                     TrF1 = id(F1, TrUserData),
    ...
    B3 = case M of
             #{id_keys := F3} ->
                 TrF3 = id(F3, TrUserData),
                 if TrF3 == [] -> B2;
                    true -> e_field_entity_ref_id_keys(TrF3, B2, TrUserData)
                 end;
             _ -> B2
         end,
    case M of
        #{description_keys := F4} ->
            TrF4 = id(F4, TrUserData),
            if TrF4 == [] -> B3;
               true -> e_field_entity_ref_description_keys(TrF4, B3, TrUserData)
            end;
        _ -> B3
    end.
...
encode_msg_resource(#{} = M, Bin, TrUserData) ->
    ...
    case M of
        #{entity_refs := F3} ->
            TrF3 = id(F3, TrUserData),
            if TrF3 == [] -> B2;
               true -> e_field_resource_entity_refs(TrF3, B2, TrUserData)
            end;
        _ -> B2
    end.
...
e_field_entity_ref_id_keys([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = e_type_string(id(Elem, TrUserData), Bin2, TrUserData),
    e_field_entity_ref_id_keys(Rest, Bin3, TrUserData);
e_field_entity_ref_id_keys([], Bin, _TrUserData) -> Bin.

e_field_entity_ref_description_keys([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 34>>,
    Bin3 = e_type_string(id(Elem, TrUserData), Bin2, TrUserData),
    e_field_entity_ref_description_keys(Rest, Bin3, TrUserData);
e_field_entity_ref_description_keys([], Bin, _TrUserData) -> Bin.
...
e_mfield_resource_entity_refs(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_entity_ref(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_resource_entity_refs([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = e_mfield_resource_entity_refs(id(Elem, TrUserData), Bin2, TrUserData),
    e_field_resource_entity_refs(Rest, Bin3, TrUserData);
e_field_resource_entity_refs([], Bin, _TrUserData) -> Bin.
...
decode_msg_2_doit(entity_ref, Bin, TrUserData) -> id(decode_msg_entity_ref(Bin, TrUserData), TrUserData);
...
decode_msg_entity_ref(Bin, TrUserData) -> dfp_read_field_def_entity_ref(Bin, 0, 0, 0, id(<<>>, TrUserData), id(<<>>, TrUserData), id([], TrUserData), id([], TrUserData), TrUserData).

dfp_read_field_def_entity_ref(<<10, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> d_field_entity_ref_schema_url(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_entity_ref(<<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> d_field_entity_ref_type(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_entity_ref(<<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> d_field_entity_ref_id_keys(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_entity_ref(<<34, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> d_field_entity_ref_description_keys(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_entity_ref(<<>>, 0, 0, _, F@_1, F@_2, R1, R2, TrUserData) -> #{schema_url => F@_1, type => F@_2, id_keys => lists_reverse(R1, TrUserData), description_keys => lists_reverse(R2, TrUserData)};
dfp_read_field_def_entity_ref(Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> dg_read_field_def_entity_ref(Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData).

dg_read_field_def_entity_ref(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 32 - 7 -> dg_read_field_def_entity_ref(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
dg_read_field_def_entity_ref(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_entity_ref_schema_url(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
        18 -> d_field_entity_ref_type(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
        26 -> d_field_entity_ref_id_keys(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
        34 -> d_field_entity_ref_description_keys(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_entity_ref(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData);
                1 -> skip_64_entity_ref(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData);
                2 -> skip_length_delimited_entity_ref(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData);
                3 -> skip_group_entity_ref(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData);
                5 -> skip_32_entity_ref(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData)
            end
    end;
dg_read_field_def_entity_ref(<<>>, 0, 0, _, F@_1, F@_2, R1, R2, TrUserData) -> #{schema_url => F@_1, type => F@_2, id_keys => lists_reverse(R1, TrUserData), description_keys => lists_reverse(R2, TrUserData)}.

d_field_entity_ref_schema_url(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> d_field_entity_ref_schema_url(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_entity_ref_schema_url(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    dfp_read_field_def_entity_ref(RestF, 0, 0, F, NewFValue, F@_2, F@_3, F@_4, TrUserData).

d_field_entity_ref_type(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> d_field_entity_ref_type(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_entity_ref_type(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    dfp_read_field_def_entity_ref(RestF, 0, 0, F, F@_1, NewFValue, F@_3, F@_4, TrUserData).

d_field_entity_ref_id_keys(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> d_field_entity_ref_id_keys(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_entity_ref_id_keys(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, Prev, F@_4, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    dfp_read_field_def_entity_ref(RestF, 0, 0, F, F@_1, F@_2, cons(NewFValue, Prev, TrUserData), F@_4, TrUserData).

d_field_entity_ref_description_keys(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> d_field_entity_ref_description_keys(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_entity_ref_description_keys(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, Prev, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    dfp_read_field_def_entity_ref(RestF, 0, 0, F, F@_1, F@_2, F@_3, cons(NewFValue, Prev, TrUserData), TrUserData).

skip_varint_entity_ref(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> skip_varint_entity_ref(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
skip_varint_entity_ref(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> dfp_read_field_def_entity_ref(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_length_delimited_entity_ref(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> skip_length_delimited_entity_ref(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData);
skip_length_delimited_entity_ref(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_entity_ref(Rest2, 0, 0, F, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_group_entity_ref(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_entity_ref(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_32_entity_ref(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> dfp_read_field_def_entity_ref(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_64_entity_ref(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData) -> dfp_read_field_def_entity_ref(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData).

decode_msg_resource(Bin, TrUserData) -> dfp_read_field_def_resource(Bin, 0, 0, 0, id([], TrUserData), id(0, TrUserData), id([], TrUserData), TrUserData).

dfp_read_field_def_resource(<<10, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> d_field_resource_attributes(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
dfp_read_field_def_resource(<<16, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> d_field_resource_dropped_attributes_count(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
dfp_read_field_def_resource(<<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> d_field_resource_entity_refs(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
dfp_read_field_def_resource(<<>>, 0, 0, _, R1, F@_2, R2, TrUserData) ->
    S1 = #{dropped_attributes_count => F@_2},
    S2 = if R1 == '$undef' -> S1;
            true -> S1#{attributes => lists_reverse(R1, TrUserData)}
         end,
    if R2 == '$undef' -> S2;
       true -> S2#{entity_refs => lists_reverse(R2, TrUserData)}
    end;
dfp_read_field_def_resource(Other, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> dg_read_field_def_resource(Other, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

dg_read_field_def_resource(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 32 - 7 -> dg_read_field_def_resource(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
dg_read_field_def_resource(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_resource_attributes(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        16 -> d_field_resource_dropped_attributes_count(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        26 -> d_field_resource_entity_refs(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_resource(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                1 -> skip_64_resource(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                2 -> skip_length_delimited_resource(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                3 -> skip_group_resource(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                5 -> skip_32_resource(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData)
            end
    end;
dg_read_field_def_resource(<<>>, 0, 0, _, R1, F@_2, R2, TrUserData) ->
    S1 = #{dropped_attributes_count => F@_2},
    S2 = if R1 == '$undef' -> S1;
            true -> S1#{attributes => lists_reverse(R1, TrUserData)}
         end,
...
d_field_resource_attributes(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 -> d_field_resource_attributes(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
d_field_resource_attributes(<<0:1, X:7, Rest/binary>>, N, Acc, F, Prev, F@_2, F@_3, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bs:Len/binary, Rest2/binary>> = Rest, {id(decode_msg_key_value(Bs, TrUserData), TrUserData), Rest2} end,
    dfp_read_field_def_resource(RestF, 0, 0, F, cons(NewFValue, Prev, TrUserData), F@_2, F@_3, TrUserData).

d_field_resource_dropped_attributes_count(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 -> d_field_resource_dropped_attributes_count(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
d_field_resource_dropped_attributes_count(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, F@_3, TrUserData) ->
    {NewFValue, RestF} = {id((X bsl N + Acc) band 4294967295, TrUserData), Rest},
    dfp_read_field_def_resource(RestF, 0, 0, F, F@_1, NewFValue, F@_3, TrUserData).

d_field_resource_entity_refs(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 -> d_field_resource_entity_refs(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
d_field_resource_entity_refs(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, Prev, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bs:Len/binary, Rest2/binary>> = Rest, {id(decode_msg_entity_ref(Bs, TrUserData), TrUserData), Rest2} end,
    dfp_read_field_def_resource(RestF, 0, 0, F, F@_1, F@_2, cons(NewFValue, Prev, TrUserData), TrUserData).

skip_varint_resource(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> skip_varint_resource(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
skip_varint_resource(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> dfp_read_field_def_resource(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

skip_length_delimited_resource(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 -> skip_length_delimited_resource(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
skip_length_delimited_resource(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_resource(Rest2, 0, 0, F, F@_1, F@_2, F@_3, TrUserData).

skip_group_resource(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_resource(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, TrUserData).

skip_32_resource(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> dfp_read_field_def_resource(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

skip_64_resource(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> dfp_read_field_def_resource(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        entity_ref -> merge_msg_entity_ref(Prev, New, TrUserData);
...
-compile({nowarn_unused_function,merge_msg_entity_ref/3}).
merge_msg_entity_ref(PMsg, NMsg, TrUserData) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
             {_, #{schema_url := NFschema_url}} -> S1#{schema_url => NFschema_url};
             {#{schema_url := PFschema_url}, _} -> S1#{schema_url => PFschema_url};
             _ -> S1
         end,
    S3 = case {PMsg, NMsg} of
    ...
    S4 = case {PMsg, NMsg} of
             {#{id_keys := PFid_keys}, #{id_keys := NFid_keys}} -> S3#{id_keys => 'erlang_++'(PFid_keys, NFid_keys, TrUserData)};
             {_, #{id_keys := NFid_keys}} -> S3#{id_keys => NFid_keys};
             {#{id_keys := PFid_keys}, _} -> S3#{id_keys => PFid_keys};
             {_, _} -> S3
         end,
    case {PMsg, NMsg} of
        {#{description_keys := PFdescription_keys}, #{description_keys := NFdescription_keys}} -> S4#{description_keys => 'erlang_++'(PFdescription_keys, NFdescription_keys, TrUserData)};
        {_, #{description_keys := NFdescription_keys}} -> S4#{description_keys => NFdescription_keys};
        {#{description_keys := PFdescription_keys}, _} -> S4#{description_keys => PFdescription_keys};
        {_, _} -> S4
    end.
...
merge_msg_resource(PMsg, NMsg, TrUserData) ->
    ...
    case {PMsg, NMsg} of
        {#{entity_refs := PFentity_refs}, #{entity_refs := NFentity_refs}} -> S3#{entity_refs => 'erlang_++'(PFentity_refs, NFentity_refs, TrUserData)};
        {_, #{entity_refs := NFentity_refs}} -> S3#{entity_refs => NFentity_refs};
        {#{entity_refs := PFentity_refs}, _} -> S3#{entity_refs => PFentity_refs};
        {_, _} -> S3
    end.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        entity_ref -> v_msg_entity_ref(Msg, [MsgName], TrUserData);
...
-compile({nowarn_unused_function,v_submsg_entity_ref/3}).
-dialyzer({nowarn_function,v_submsg_entity_ref/3}).
v_submsg_entity_ref(Msg, Path, TrUserData) -> v_msg_entity_ref(Msg, Path, TrUserData).

-compile({nowarn_unused_function,v_msg_entity_ref/3}).
-dialyzer({nowarn_function,v_msg_entity_ref/3}).
v_msg_entity_ref(#{} = M, Path, TrUserData) ->
    case M of
        #{schema_url := F1} -> v_type_string(F1, [schema_url | Path], TrUserData);
        _ -> ok
    end,
    case M of
    ...
    case M of
        #{id_keys := F3} ->
            if is_list(F3) ->
                   _ = [v_type_string(Elem, [id_keys | Path], TrUserData) || Elem <- F3],
                   ok;
               true -> mk_type_error({invalid_list_of, string}, F3, [id_keys | Path])
            end;
        _ -> ok
    end,
    case M of
        #{description_keys := F4} ->
            if is_list(F4) ->
                   _ = [v_type_string(Elem, [description_keys | Path], TrUserData) || Elem <- F4],
                   ok;
               true -> mk_type_error({invalid_list_of, string}, F4, [description_keys | Path])
            end;
        _ -> ok
    end,
    lists:foreach(fun (schema_url) -> ok;
                      (type) -> ok;
                      (id_keys) -> ok;
                      (description_keys) -> ok;
                      (OtherKey) -> mk_type_error({extraneous_key, OtherKey}, M, Path)
                  ...
                  maps:keys(M)),
    ok;
v_msg_entity_ref(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), entity_ref}, M, Path);
v_msg_entity_ref(X, Path, _TrUserData) -> mk_type_error({expected_msg, entity_ref}, X, Path).
...
v_msg_resource(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{entity_refs := F3} ->
            if is_list(F3) ->
                   _ = [v_submsg_entity_ref(Elem, [entity_refs | Path], TrUserData) || Elem <- F3],
                   ok;
               true -> mk_type_error({invalid_list_of, {msg, entity_ref}}, F3, [entity_refs | Path])
            end;
        _ -> ok
    end,
...
get_msg_defs() ->
    [{{enum, 'span.SpanKind'}, [{'SPAN_KIND_UNSPECIFIED', 0}, {'SPAN_KIND_INTERNAL', 1}, {'SPAN_KIND_SERVER', 2}, {'SPAN_KIND_CLIENT', 3}, {'SPAN_KIND_PRODUCER', 4}, {'SPAN_KIND_CONSUMER', 5}]},
     ...
     {{enum, 'opentelemetry.proto.trace.v1.SpanFlags'}, [{'SPAN_FLAGS_DO_NOT_USE', 0}, {'SPAN_FLAGS_TRACE_FLAGS_MASK', 255}, {'SPAN_FLAGS_CONTEXT_HAS_IS_REMOTE_MASK', 256}, {'SPAN_FLAGS_CONTEXT_IS_REMOTE_MASK', 512}]},
     ...
     {{msg, instrumentation_scope},
      [#{name => name, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []},
       ...
       #{name => dropped_attributes_count, fnum => 4, rnum => 5, type => uint32, occurrence => optional, opts => []}]},
     {{msg, entity_ref},
      [#{name => schema_url, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []},
       #{name => type, fnum => 2, rnum => 3, type => string, occurrence => optional, opts => []},
       #{name => id_keys, fnum => 3, rnum => 4, type => string, occurrence => repeated, opts => []},
       #{name => description_keys, fnum => 4, rnum => 5, type => string, occurrence => repeated, opts => []}]},
     {{msg, resource},
      [#{name => attributes, fnum => 1, rnum => 2, type => {msg, key_value}, occurrence => repeated, opts => []},
       #{name => dropped_attributes_count, fnum => 2, rnum => 3, type => uint32, occurrence => optional, opts => []},
       #{name => entity_refs, fnum => 3, rnum => 4, type => {msg, entity_ref}, occurrence => repeated, opts => []}]}].
...
find_enum_def('opentelemetry.proto.trace.v1.SpanFlags') -> [{'SPAN_FLAGS_DO_NOT_USE', 0}, {'SPAN_FLAGS_TRACE_FLAGS_MASK', 255}, {'SPAN_FLAGS_CONTEXT_HAS_IS_REMOTE_MASK', 256}, {'SPAN_FLAGS_CONTEXT_IS_REMOTE_MASK', 512}];
...
'enum_symbol_by_value_opentelemetry.proto.trace.v1.SpanFlags'(256) -> 'SPAN_FLAGS_CONTEXT_HAS_IS_REMOTE_MASK';
'enum_symbol_by_value_opentelemetry.proto.trace.v1.SpanFlags'(512) -> 'SPAN_FLAGS_CONTEXT_IS_REMOTE_MASK'.
...
'enum_value_by_symbol_opentelemetry.proto.trace.v1.SpanFlags'('SPAN_FLAGS_CONTEXT_HAS_IS_REMOTE_MASK') -> 256;
'enum_value_by_symbol_opentelemetry.proto.trace.v1.SpanFlags'('SPAN_FLAGS_CONTEXT_IS_REMOTE_MASK') -> 512.
...
fqbin_to_msg_name(<<"opentelemetry.proto.common.v1.EntityRef">>) -> entity_ref;
...
msg_name_to_fqbin(entity_ref) -> <<"opentelemetry.proto.common.v1.EntityRef">>;
...
get_msg_containment("common") -> [any_value, array_value, entity_ref, instrumentation_scope, key_value, key_value_list];
...
get_proto_by_msg_name_as_fqbin(<<"opentelemetry.proto.common.v1.EntityRef">>) -> "common";
