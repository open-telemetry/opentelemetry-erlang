...
'e_enum_span.SpanKind'('CLIENT', Bin, _TrUserData) ->
    <<Bin/binary, 3>>;
'e_enum_span.SpanKind'('PRODUCER', Bin, _TrUserData) ->
    <<Bin/binary, 4>>;
'e_enum_span.SpanKind'('CONSUMER', Bin, _TrUserData) ->
    <<Bin/binary, 5>>;
...
'enum_symbol_by_value_status.StatusCode'(2) ->
    'UnknownError';
'enum_symbol_by_value_status.StatusCode'(3) ->
    'InvalidArgument';
'enum_symbol_by_value_status.StatusCode'(4) ->
    'DeadlineExceeded';
'enum_symbol_by_value_status.StatusCode'(5) ->
    'NotFound';
'enum_symbol_by_value_status.StatusCode'(6) ->
    'AlreadyExists';
'enum_symbol_by_value_status.StatusCode'(7) ->
    'PermissionDenied';
'enum_symbol_by_value_status.StatusCode'(8) ->
    'ResourceExhausted';
'enum_symbol_by_value_status.StatusCode'(9) ->
    'FailedPrecondition';
'enum_symbol_by_value_status.StatusCode'(10) ->
    'Aborted';
'enum_symbol_by_value_status.StatusCode'(11) ->
    'OutOfRange';
'enum_symbol_by_value_status.StatusCode'(12) ->
    'Unimplemented';
'enum_symbol_by_value_status.StatusCode'(13) ->
    'InternalError';
'enum_symbol_by_value_status.StatusCode'(14) ->
    'Unavailable';
'enum_symbol_by_value_status.StatusCode'(15) ->
    'DataLoss';
'enum_symbol_by_value_status.StatusCode'(16) ->
    'Unauthenticated'.


'enum_value_by_symbol_status.StatusCode'('Ok') -> 0;
'enum_value_by_symbol_status.StatusCode'('Cancelled') ->
    1;
'enum_value_by_symbol_status.StatusCode'('UnknownError') ->
    2;
'enum_value_by_symbol_status.StatusCode'('InvalidArgument') ->
    3;
'enum_value_by_symbol_status.StatusCode'('DeadlineExceeded') ->
    4;
'enum_value_by_symbol_status.StatusCode'('NotFound') ->
    5;
'enum_value_by_symbol_status.StatusCode'('AlreadyExists') ->
    6;
'enum_value_by_symbol_status.StatusCode'('PermissionDenied') ->
    7;
'enum_value_by_symbol_status.StatusCode'('ResourceExhausted') ->
    8;
'enum_value_by_symbol_status.StatusCode'('FailedPrecondition') ->
    9;
'enum_value_by_symbol_status.StatusCode'('Aborted') ->
    10;
'enum_value_by_symbol_status.StatusCode'('OutOfRange') ->
    11;
'enum_value_by_symbol_status.StatusCode'('Unimplemented') ->
    12;
'enum_value_by_symbol_status.StatusCode'('InternalError') ->
    13;
'enum_value_by_symbol_status.StatusCode'('Unavailable') ->
    14;
'enum_value_by_symbol_status.StatusCode'('DataLoss') ->
    15;
